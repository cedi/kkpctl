...
func (r clusterProjectRender) ParseObject(inputObj any, output string) (string, error) {
...
func (r clusterProjectRender) ParseCollection(inputObj any, output string, sortBy string) (string, error) {
	var err error
